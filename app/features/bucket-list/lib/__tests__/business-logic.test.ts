...
import type { BucketItem, Category, BucketItemInsert, BucketItemUpdate } from '~/features/bucket-list/types'
...
describe('Business Logic Functions', () => {
  ...
  describe('filterItemsBySearch', () => {
    ...
    it('説明で検索できること', () => {
      const items = [
        createMockItem({ id: '1', title: 'Travel', description: 'Visit Tokyo' }),
  ...
  describe('sortItems', () => {
    ...
    it('優先度でソートできること', () => {
      ...
      expect(result.map(item => item.priority)).toEqual(['high', 'medium', 'low'])
    })
    ...
    it('作成日でソートできること', () => {
      ...
      const result = sortItems(items, { field: 'created_at', direction: 'asc' })
  ...
  describe('getRecentlyCompletedItems', () => {
    it('最近完了した項目を取得できること', () => {
      const items = [
        createMockItem({ id: '1', status: 'completed', completed_at: '2024-01-10T00:00:00Z' }),
        createMockItem({ id: '2', status: 'completed', completed_at: '2024-01-15T00:00:00Z' }),
        createMockItem({ id: '3', status: 'not_started' }),
        createMockItem({ id: '4', status: 'completed', completed_at: '2024-01-05T00:00:00Z' }),
      ]
  ...
  describe('getUpcomingItems', () => {
    ...
    it('期限が近い項目を取得できること', () => {
      const items = [
        createMockItem({ id: '1', due_date: '2024-01-20', status: 'not_started' }), // 5日後
        createMockItem({ id: '2', due_date: '2024-01-25', status: 'in_progress' }), // 10日後
        createMockItem({ id: '3', due_date: '2024-02-20', status: 'not_started' }), // 範囲外
        createMockItem({ id: '4', due_date: '2024-01-18', status: 'completed' }), // 完了済み（除外）
      ]
