...
export const createNotFoundError = (resource: string, id?: string, message?: string): NotFoundError => ({
  type: 'NotFoundError',
  resource,
  id,
 ...
 * エラーの型判定ヘルパー関数群
 */
export const isValidationError = (error: BucketListError): error is ValidationError =>
  error.type === 'ValidationError';

export const isDatabaseError = (error: BucketListError): error is DatabaseError =>
  error.type === 'DatabaseError';

export const isAuthenticationError = (error: BucketListError): error is AuthenticationError =>
  error.type === 'AuthenticationError';

export const isNotFoundError = (error: BucketListError): error is NotFoundError =>
  error.type === 'NotFoundError';

export const isConflictError = (error: BucketListError): error is ConflictError =>
  error.type === 'ConflictError';

export const isNetworkError = (error: BucketListError): error is NetworkError =>
  error.type === 'NetworkError';

export const isBusinessRuleError = (error: BucketListError): error is BusinessRuleError =>
  error.type === 'BusinessRuleError';

export const isApplicationError = (error: BucketListError): error is ApplicationError =>
